  ...
  return (
    <section className="relative w-full h-screen flex items-center justify-center text-center text-white overflow-hidden">
      ...
      <div className="relative z-10 px-5 max-w-4xl">
        <h1 className="text-6xl md:text-8xl font-black text-amber-400 tracking-widest mb-3 drop-shadow-2xl">
          GAIA
        </h1>
        
        <div className="w-24 h-1 bg-amber-400 mx-auto mb-8" />
        
        <p className="text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed font-light text-gray-100">
